...
SpellRes::SpellRes(int param_spell_id
	...
	, int param_distance)
{
	...
	effect_value = param_effect_value;
...
{
	//先手动加几个技能吧,不从资源里读取了
	SpellRes jiaxue(1001, UV_SPELL_EFFECT_INC_HP, 100, 5, 100, 500); //加血技能
	SpellRes jiamo(1002, UV_SPELL_EFFECT_INC_MP, 50, 3, 40, 100);   //加魔法技能
	SpellRes damage(1003, UV_SPELL_EFFECT_DEC_MP, 600, 2, 30, 400);  //攻击技能
